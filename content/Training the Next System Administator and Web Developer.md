...
[^Mono Kernel]: [https://en.wikipedia.org/wiki/Monolithic_kernel](https://en.wikipedia.org/wiki/Monolithic_kernel)
[^Micro kernel]: [https://en.wikipedia.org/wiki/Microkernel](https://en.wikipedia.org/wiki/Microkernel)
[^Hybrid Kernel]: [https://en.wikipedia.org/wiki/Hybrid_kernel](https://en.wikipedia.org/wiki/Hybrid_kernel)
[^Linux Time Line]: [https://en.wikipedia.org/wiki/History_of_Linux](https://en.wikipedia.org/wiki/History_of_Linux)
